...
import 'package:social_app_kevin_salazar/features/post/presentation/components/comment_tile.dart';
...
import 'package:social_app_kevin_salazar/features/profile/domain/data/presentation/pages/profile_page.dart';
            ...
            child: Row(
              children: [
                SizedBox(
                  ...
                  //like count
                  Text(widget.post.likes.length.toString(),style:TextStyle(
                    color:Theme.of(context).colorScheme.primary,
                    fontSize: 12,
                   ),
                  ),
